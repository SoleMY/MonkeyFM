...
- (void)initLayout
{
    ...
    self.playImageView.image = [[UIImage imageNamed:@"play90"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    ...
    [self.listenPeopleNum mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.heardImageView.mas_top).offset(kSmallSpace);
    ...
    [self.attentionLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.attentionImageView.mas_top).offset(kSmallSpace);
